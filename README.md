...
To help you explore the system quickly, here are some ready-to-use accounts created by the database seeders:

🏷️ Role	      👤 Name	         📧 Email	            🔑 Password	      ✨ Access
🛠️ Admin	    Admin	         admin@example.com 	  password	      Manage doctors, patients, appointments, slots, & system settings
🩺 Doctor	   Dr. John Doe	  doctor@example.com	    password	   View profile, availability, and manage appointments
👩‍🦰 Patient	   Jane Smith	     patient@example.com	 password	   Book appointments with doctors
